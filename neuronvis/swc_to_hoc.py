...
class SWC(object):
    ...
    def load(self, filename):
        ...
        if self.scales is not None:
            self.rescale(x=self.scales['x'], y=self.scales['y'], z=self.scales['z'], r=self.scales['r'])
